...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function createItemCard(item) {
    ...
    if (item.image) {
      ...
      const base64Image = btoa(
        String.fromCharCode.apply(null, new Uint8Array(item.image.data || []))
      );
  ...
  function updateInventoryStats() {
    ...
    if (document.getElementById("admin-available-count")) {
      ...
      document.getElementById("admin-available-count").textContent =
        availableItems;
    }
    ...
    if (document.getElementById("admin-borrowed-count")) {
      ...
      document.getElementById("admin-borrowed-count").textContent =
        borrowedItems;
    }
  }
  ...
  function openBorrowModal(item) {
    ...
    document
      .querySelector("#borrow-modal .close")
      .addEventListener("click", function () {
        modal.style.display = "none";
      });

    document
      .getElementById("cancel-borrow")
      .addEventListener("click", function () {
        modal.style.display = "none";
      });
    ...
    document
      ...
      .addEventListener("submit", function (e) {
        ...
        const borrowData = {
          ...
          returnTime: addHours(
            new Date(),
            parseInt(document.getElementById("time-to-use").value)
          ).toISOString(),
        };
  ...
  function initCharts(data) {
    ...
    if (document.getElementById("borrowedItemsChart")) {
      const ctx = document
        .getElementById("borrowedItemsChart")
        .getContext("2d");
      new Chart(ctx, {
        type: "pie",
        data: {
